  ...
  return (
    <>
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-orbitron sm:gap-5 md:gap-5 items-center mx-auto w-full">
        ...
        <div className="bg-white-A700 flex flex-col font-montserrat md:gap-10 gap-[73px] items-center justify-start p-10 md:px-5 w-[84%] md:w-full">
          <Text
          ...
          <div className="h-[146px] md:h-[707px] sm:h-[915px] mb-[409px] relative w-full">
            <div className="flex flex-col h-full items-center justify-start m-auto w-full">
              <div className="flex flex-col gap-12 items-center justify-start w-full">
                ...
                <div className="flex flex-col items-center justify-start w-[98%] md:w-full">
                  <List
                    className="sm:flex-col flex-row gap-4 grid sm:grid-cols-1 md:grid-cols-3 grid-cols-6 justify-center w-full"
            ...
            <div className="absolute bottom-[12%] flex flex-col items-center justify-start right-[1%] w-[28%]">
              <div className="bg-white-A700 border border-gray-500_7f border-solid flex flex-col gap-[19px] items-start justify-start p-[13px] rounded-md shadow-bs1 w-full">
                <Text
                  className="mt-[5px] text-gray-900_01 text-sm"
                  size="txtMontserratRomanMedium14"
                >
                  Date{" "}
                </Text>
                <Text
                  className="mb-2 text-gray-900_01 text-sm"
                  size="txtMontserratRomanMedium14"
                >
...
export default ContractspageOnePage;
