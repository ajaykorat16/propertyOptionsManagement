                  ...
                  <div className="flex md:flex-1 sm:flex-col flex-row gap-2 items-center justify-between w-[67%] md:w-full">
                    <div className="flex flex-row gap-2 items-center justify-between w-1/2 sm:w-full">
                      <div className="flex flex-col gap-2 items-center justify-start w-[49%]">
                        <div className="h-[89px] relative w-[89px]">
                          <Img
                            className="h-[89px] m-auto object-cover w-[89px]"
                            src="images/img_image5.png"
                            alt="imageFive"
                          />
                          <div className="absolute bg-gray-900_90 flex flex-col h-full inset-[0] items-end justify-center m-auto pb-[65px] md:pl-10 sm:pl-5 pl-[65px] w-[89px]">
                            <Img
                              className="h-6 w-6"
...
export default FinishespageOnePage;
