...
const ResetPasswordPage = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-orbitron sm:gap-[48px] md:gap-10 gap-[71px] items-center mx-auto md:pr-2 sm:pr-5 pr-[71px] w-full main-container">
        ...
        <div className="flex flex-col font-montserrat items-center justify-start w-[26%] md:w-full ">
          ...
          <form onSubmit={handleSubmit} className="form-container sm:pt-0 sm:w-[269px] sm:h-[71px]">
            <div className="flex flex-col items-center justify-start mt-[45px] sm:mt-[8px] w-full ">
              ...
              <div className="flex flex-col gap-[29px] sm:gap-[16px] items-end justify-start mt-[20px] w-full">
